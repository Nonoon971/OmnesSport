...
<div id="demo5" class="modal">
	...
	//Rappel: votre serveur = localhost et votre login = root et votre password = <rien>
		...
		if ($db_found)
		{
			$sql = "SELECT Nom, Prenom, Tel, Profession, Email,CV FROM utilisateur WHERE Type = 'coach' AND Profession ='coach de cours collectifs'"; //Le cv se peut qu'il doit être récupéré quand on clique sur le bouton
		...
		<div id="boutton">
			...
			<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href = 'collectif.php';" style="width: 150px;">Echanger avec <br>le coach</button>
			<button type="button" class="btn btn-warning btn-lg" onclick="window.location.href = 'collectif.php';">Voir son CV</button>
