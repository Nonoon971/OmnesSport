...
<div id="demo1" class="modal">
	...
	//Rappel: votre serveur = localhost et votre login = root et votre password = <rien>
		...
		if ($db_found)
		{
			$sql = "SELECT Nom, Prenom, Tel, Profession, Email,CV,Online FROM utilisateur WHERE Type = 'coach' AND Profession ='coach de football'"; //Le cv se peut qu'il doit être récupéré quand on clique sur le bouton
