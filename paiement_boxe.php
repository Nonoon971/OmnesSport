...
<body>
                ...
                <div class="collapse show p-3 pt-0" id="collapseExample">
                    <div class="row">
                        <div class="col-lg-5 mb-lg-0 mb-3">
                            ...
                            <p class="mb-0">
                                <span class="fw-bold">Heure et date de la reservation: <?php echo $Hresa." le ". $Jresa ?></span>
    ...
    <div class="col-12">
       ...
       <?php  echo "<a href='reservationPaiement.php?Jour=".$Jresa."&Heure=".$Hresa."&Sport=".$Sport."' class='btn btn-primary payment'>PAYER</a>"?>
        <script type="text/javascript">
          document.getElementById("myButton").onclick = function () {
            location.href = "reservationPaiement.php";
         };
