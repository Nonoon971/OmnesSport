...
<?php else: ?>
	...
	$query = mysqli_query($conn,"SELECT Nom, Prenom FROM utilisateur WHERE Profession = 'coach de plongeon'");
	?>
	...
	<?php else: ?>
		...
		<body>
			...
			<div id="section">
				...
				<p>Notre complexe organise des cours de plongeon pour que tu puisses améliorer tes qualités dans ce sport</p> 
				...
				<div id="description">
					<p> Salut moi c'est <?php echo $prenom ."&nbsp;" .$nom;  ?>, avec moi, tu vas devenir le meilleur plongeur de ton groupe d'ami, donc réserve dès maintenant ton rendez-vous !</p>

					<p id="dispo"> Voici mes disponibilités </p> 
					
					<?php  $coachName=$nom ; $Sport='plongeon';?>
