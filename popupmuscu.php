...
<div id="demo" class="modal">
	...
	//Rappel: votre serveur = localhost et votre login = root et votre password = <rien>
		...
		if ($db_found)
		{
			$sql = "SELECT Nom, Prenom, Tel, Profession, Email,CV, Online FROM utilisateur WHERE Type = 'coach' AND Profession ='coach de musculation'"; //Le cv se peut qu'il doit être récupéré quand on clique sur le bouton
		...
		<div id="boutton">
			...
			<!-- Si le coach est pas connecté on affiche pas le bouton -->
